...
//General function to delete an entry from the db by the id
function ExecuteDeleteActionDb(urlpart)
{
	"use strict";
...
function deleteFertigungAbteilung(abteilungsID,fertigungsID) {
	...
	"use strict";
	alter("deleteFertigungAbteilung")
	ExecuteDeleteActionDb("addgetdeleteobject?type=Abteilung&parent="+abteilungsID+"&id="+fertigungsID);	
}

function deleteFertigungAbteilung() {
