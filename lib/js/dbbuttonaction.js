...
function ExecuteCreateActionDb(urlpart,data)
{
	...
	var url = apiadress+urlpart+"/Create/?value="+data;
...
//General function to create an entry in the db
function ExecuteCreateActionDbUrl(urlpart,message)
{
	alert("ExecuteCreateActionDb with url path: "+urlpart);
...
function ExecuteUpdateActionDb(urlpart,id,data)
{
	"use strict";
	var url = apiadress+urlpart+"/Update/?id="+id+"&value="+data;
//	alert(url)
	xhttp.onreadystatechange = function () {
//		alert("readyState: " + this.readyState);
//		alert("status: " + this.status);
...
function ExecuteDeleteActionDb(urlpart,id)
{
	...
	var url = apiadress+urlpart+"/Delete?id="+id;
...
function createRegistierung(data)
{
	"use strict";
	ExecuteCreateActionDb("user",data);
}

function createLogin(data)
{
	"use strict";
	ExecuteCreateActionDb("login",data);
}

function createUserAnfrage(data)
{
	"use strict";
	ExecuteCreateActionDb("userAnfrage",data);
}
...
function updateBauteil(data,id) {
	...
	"use strict";
	ExecuteUpdateActionDb("bauteil",id,data);
...
function updateMaschine(data,id) {
	...
	"use strict";
	ExecuteUpdateActionDb("maschine",id,data);
}
...
function addArbeitsfolgeFertigungs(fertigungslinieID,arbeitsfolgeID){
	"use strict";
	ExecuteCreateActionDbUrl("addgetdeleteobject/create/?type=Fertigungslinie&parent="+fertigungslinieID+"&id="+arbeitsfolgeID,"Arbeitsfolge der Fertigungslinie hinzufügen");
}
...
function deleteArbeitsfolgeFertigungslinien(FertigungslinienID, vonArbeitsfolgeID) {
	...
	ExecuteDeleteActionDbSingle("addgetdeleteobject/remove/?type=Fertigungslinie&parent="+FertigungslinienID+"&id="+vonArbeitsfolgeID);	
	}
...
function addFertigungslinieFertigung(fertigungsID,fertigungslinie){
	"use strict";
	ExecuteCreateActionDbUrl("addgetdeleteobject/create/?type=Fertigung&parent="+fertigungsID+"&id="+fertigungslinie,"Fertigungslinie der Fertigung hinzufügen");
}
...
function deleteFertigungslinieFertigung(fertigungsID,fertigungslinieID) {
	...
	"use strict";
	ExecuteDeleteActionDbSingle("addgetdeleteobject/remove/?type=Fertigung&parent="+fertigungsID+"&id="+fertigungslinieID);	
}
...
function addFertigungAbteilung(abteilungsID,fertigungsID){
	"use strict";
	ExecuteCreateActionDbUrl("addgetdeleteobject/create/?type=Abteilung&parent="+abteilungsID+"&id="+fertigungsID,"Fertigung der Abteilung hinzufügen");
}
...
function deleteFertigungAbteilung(abteilungsID,fertigungsID) {
	...
	"use strict";
	ExecuteDeleteActionDbSingle("addgetdeleteobject/remove/?type=Abteilung&parent="+abteilungsID+"&id="+fertigungsID);	
}
...
function saveWartung(data, zugriff, id){
	...
	if(zugriff == 1) 
	{
		ExecuteUpdateActionDb("wartung",id,data);
	}
...
function saveAudit(data, zugriff){
	...
	if(zugriff == 1) 
	{
		ExecuteUpdateActionDb("audit",data["auditId"],data);
	}
