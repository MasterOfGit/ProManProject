...
// nochnicht registriere User Menue
...
{
	"use strict";
	var url = "http://zoomnation.selfhost.eu:8080/ProManAPI/API/Bauteil";
	var data = "{'bauteileID':1,'bauteinNummer':'120 150 115','bauteilIndex':'A','bauteilVersiom':'3.1','bauteilArt':'Zahnrad','bauteilStatus':'Serienteil','bauteilIDNachfolger':null}";
	...
	xhttp.setRequestHeader("Content-type", "application/json");
	xhttp.send("");
	$("#systemstatus").html("Bauteil erzeugt !! --" + xhttp.responseText);
}
