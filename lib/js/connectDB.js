...
function FunctionAbtStatus() {
	"use strict";
	
	$("#daten").html(xhttp.responseText);
	$("#systemstatus").html("AbteilungsStatus wurden geladen ");
}

function FunctionLinienStatus() {
	"use strict";
	
	$("#daten").html(xhttp.responseText);
	$("#systemstatus").html("Fertigungslinienstatus wurden geladen ");
}

function FunctionInstandhaltung() {
	"use strict";
	
	$("#daten").html(xhttp.responseText);
	$("#systemstatus").html("Instandhaltung wurden geladen ");
}

function FunctionProduktionsplanung() {
	"use strict";
	
	$("#daten").html(xhttp.responseText);
	$("#systemstatus").html("Produktionsplanung wurden geladen ");
}

function FunctionSonderaufgaben() {
	"use strict";
	
	$("#daten").html(xhttp.responseText);
	$("#systemstatus").html("Sonderaufgaben wurden geladen ");
}
