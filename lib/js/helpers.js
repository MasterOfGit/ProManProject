...
function createCanvas(){
	...
	ctx.font = "30px Arial";
	ctx.fillText("Abteilungsuebersicht", 10, 50);

	ctx.font = "10px Arial";
	ctx.fillText("Machine_1", 30 + 25, 100 + 30);
	ctx.strokeRect(30, 100, 100, 50);
	...
	ctx.font = "10px Arial";
	ctx.fillText("Machine_2", 30 + 25, 180 + 30);
	ctx.strokeRect(30, 180, 100, 50);
	...
	ctx.font = "10px Arial";
	ctx.fillText("Machine_3", 30 + 25, 260 + 30);
	ctx.strokeRect(30, 260, 100, 50);
