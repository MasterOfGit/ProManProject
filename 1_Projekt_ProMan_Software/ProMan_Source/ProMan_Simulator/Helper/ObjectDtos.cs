...
{
    public static class ObjectDtos
    {
        public const string WerkDtoName = "Werk";
        public const string AbteilungDtoName = "Abteilung"; 
        public const string FertigungDtoName = "Fertigung";
        public const string FertigungslinieDtoName = "Fertigungslinie";
        public const string MaschineDtoName = "Maschine";
